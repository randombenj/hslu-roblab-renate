#!/usr/bin/env python
# Class autogenerated from /home/sam/Downloads/aldebaran_sw/nao/naoqi-sdk-2.1.4.13-linux64/include/alproxies/alsonarproxy.h
...
class ALSonar(object):
    def __init__(self, session):
        self.proxy = None 
        self.session = session

    def force_connect(self):
        self.proxy = self.session.service("ALSonar")
    ...
    def getFilteredValues(self):
        ...
        if not self.proxy:
            self.proxy = self.session.service("ALSonar")
        return self.proxy.getFilteredValues()
